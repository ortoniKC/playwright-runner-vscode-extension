...
- Enhanced documentation and added a detailed README file.
  ...
  - Registered event listeners to handle changes to the OrtoniRunner.environments setting and automatically refresh the tree view.
  - Added the setDefaultEnvironment command to set the default environment for running tests.
  - Modified the extension.runTest command to utilize the selected environment configuration when executing Playwright tests.
